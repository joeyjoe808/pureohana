      ...
      <section className="bg-white py-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 max-w-7xl mx-auto">
          {[
            ...
            "https://ujpvlaaitdudcawgcyik.supabase.co/storage/v1/object/public/pureohanatreasures/untitled-03371.jpg",
          ...
          <div className="mt-16 text-gray-400 font-light text-sm">
            ...
            <div className="mt-8">
              <a 
                ...
                className="inline-flex items-center justify-center text-gray-400 hover:text-gray-900 transition-colors"
              ...
              >
                ...
                <span className="ml-2 text-sm tracking-wider">@PUREOHANATREASURES</span>
              </a>
            </div>
          </div>
        </div>
