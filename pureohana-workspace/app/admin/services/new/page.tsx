...
import { ArrowLeft, Save, Eye, AlertCircle, ImagePlus, X, Plus, Trash2 } from 'lucide-react'
...
export default function NewServicePage() {
  ...
  const handleSubmit = async (e: React.FormEvent, setActive: boolean = true) => {
    e.preventDefault()
    setError(null)
    setLoading(true)
  ...
  return (
    <Container className="py-12">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Form */}
        <form onSubmit={(e) => handleSubmit(e, formData.is_active)} className="bg-white rounded-luxury-lg shadow-luxury p-8">
          {/* Title */}
          <div className="mb-6">
        ...
        <div className="mt-6 bg-blue-50 border-2 border-blue-200 rounded-luxury p-6">
          <p className="font-serif text-sm text-blue-900 mb-2">
            <strong>Service Tips:</strong>
          </p>
          <ul className="font-serif text-sm text-blue-800 space-y-1 list-disc list-inside">
            <li>Use clear, descriptive titles that highlight the service type</li>
            <li>Write engaging descriptions that showcase the value and experience</li>
            <li>List 3-5 key features that are included in the service</li>
            <li>Choose a stunning cover photo that represents the service</li>
          </ul>
        </div>
      </div>
