    ...
    return (
      <Container className="py-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="font-serif text-charcoal-600">Loading blog post...</p>
        </div>
      </Container>
    )
  }
    ...
    return (
      <Container className="py-12">
        <div className="max-w-4xl mx-auto">
          <div className="bg-red-50 border-2 border-red-200 rounded-luxury p-8 text-center">
            <AlertCircle size={48} className="text-red-600 mx-auto mb-4" />
            <Heading level={2} className="mb-2">Error Loading Blog Post</Heading>
            <p className="font-serif text-red-800 mb-6">{error}</p>
            <Link
              href="/admin/blog"
              className="inline-flex items-center gap-2 bg-sunset-600 text-white py-3 px-6 rounded-luxury font-serif font-medium hover:bg-sunset-700 transition-colors"
            >
              <ArrowLeft size={20} />
              Back to Blog Posts
            </Link>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="font-serif text-charcoal-600">
            Update your photography insights and island stories
          </p>
        </div>
